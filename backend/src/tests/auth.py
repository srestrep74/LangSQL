...
@pytest.mark.asyncio
async def test_get_user(user_service, mock_user_data):
...
@pytest.mark.asyncio
async def test_update_user(user_service, mock_user_data):
    user_id = "507f1f77bcf86cd799439011"
...
@pytest.mark.asyncio
async def test_login_success(user_service, mock_user_data):
    email = "test@example.com"
...
@pytest.mark.asyncio
async def test_login_failure(user_service):
    email = "test@example.com"
...
@pytest.mark.asyncio
async def test_add_credential_success(user_service, mock_user_data, mock_credential):
    user_id = "507f1f77bcf86cd799439011"
...
@pytest.mark.asyncio
async def test_add_credential_failure(user_service, mock_credential):
    user_id = "507f1f77bcf86cd799439011"
...
@pytest.mark.asyncio
async def test_remove_credential_invalid_index(user_service, mock_user_data):
    user_id = "507f1f77bcf86cd799439011"
...
@pytest.mark.asyncio
async def test_remove_main_credential(user_service, mock_user_data, mock_credential):
    user_id = "507f1f77bcf86cd799439011"
    credential_index = 0
...
@pytest.mark.asyncio
async def test_set_main_credential_invalid_index(user_service, mock_user_data):
    user_id = "507f1f77bcf86cd799439011"
    credential_index = 999  # Invalid index
